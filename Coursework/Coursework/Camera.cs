...
namespace Coursework
{
    class Camera
    {
        ...
        public Vector3 Target
        {
            ...
            set { targetPosition = value;needViewResync = true;}
        }
        ...
        public float Elevation
        {
            ...
            set { elevation = MathHelper.Clamp(value, MathHelper.ToRadians(-70), MathHelper.ToRadians(-10)); needViewResync = true; }
        }

        public float Rotation
        {
            get { return rotation; }
            set { rotation = MathHelper.WrapAngle(value); needViewResync = true; }
        }

        public float ViewDistance
        {
            get { return viewDistance; }
            set { viewDistance = MathHelper.Clamp(value, minDistance, maxDistance); }
        }
        ...
        public Matrix View
        {
            ...
            public Camera(Vector3 targetPosition, float initialElevation, float initialRotation,
            float minDistance, float maxDistance, float initialDistance, float aspectRatio,
